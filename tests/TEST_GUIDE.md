...
**Scope note:** This guide is primarily about testing (manual happy path + automated pytest). If you want the full “from clone to working stack” cold start walkthrough, see [docs/cold-start-walkthrough.md](../docs/cold-start-walkthrough.md).
...
Moved to: [docs/cold-start-walkthrough.md](../docs/cold-start-walkthrough.md)
